 ...
 * ----------------------------
 * This file implements updated object behaviors related to native functions,
 * including constructor changes for enhanced runtime validation.
 *
 * Intended solely for coursework submission and review.
 * Not guaranteed to function independently.
 */
