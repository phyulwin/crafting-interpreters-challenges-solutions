 ...
 * ----------------------------
 * This header reflects supporting definitions for VM changes related to
 * function calls and native execution enhancements.
 *
 * Included as part of an academic assignment submission.
