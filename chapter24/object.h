 ...
 * ----------------------------
 * This header includes structural changes for native function support,
 * including arity tracking and updated function signatures.
 *
 * Provided for academic submission only.
 * Not intended for standalone compilation or production use.
 */
